...
public class Sister {
	public void sister() {
		System.out.println("This is default method from sister class");
	}
	...
	public int sister(int age2, int age5, String age4) {
		int total3 = age2 + age5 + Integer.parseInt(age4);
		System.out.println("This is the return type paramerized " + total3);
		return total3;

	}

	public static int sister(int age3, String age4, int age5, int age6) {
		int total4 = age3 + Integer.parseInt(age4) + age5 + age6;
		System.out.println("This is ststic type method:" + total4);
		return total4;

	}

	public final int sister(int age2, int age3, String age4, int age5, int age6) {
		int total5 = age2 + age3 + Integer.parseInt(age4) + age5 + age6;
		System.out.println("This is final type method:" + total5);
		return total5;
